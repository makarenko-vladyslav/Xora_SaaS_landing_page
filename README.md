...
Сutting-edge SaaS landing page, showcasing clean, modern UI/UX principles and a highly responsive design. Built with React.js and Tailwind CSS, Xora offers stunning animations and fluid user interactions, making it an ideal starting point or inspiration for your next web project.
...
👉 **Stunning Sections**: Includes hero, features, pricing, FAQ, testimonials, and software download sections.

👉 **Smooth Animations**:  Built with dynamic and fluid CSS animations.

👉 **Cool CSS Gradients**: Beautifully designed CSS gradient effects using before and after pseudo-elements.

👉 **Seamless Navigation**: Intuitive navigation and smooth scrolling across the site.

👉 **Optimized Performance**: Engineered for high performance and fast loading times.

👉 **Pixel Perfect Design**: Fully responsive across all devices, ensuring a flawless user experience.

## <a name="quick-start">🤸 Quick Start</a>

Follow these steps to get Xora up and running on your local machine.
...
```bash
git clone https://github.com/makarenko-vladyslav/Xora_SaaS_landing_page.git
cd xora
```
...
Check out the key configuration files for Tailwind and CSS below.
...
All the assets used in this project can be downloaded [here](https://drive.google.com/file/d/1u-l3p3qCnrwmWq5-bG7OkfCXFPYM9t5z/view?usp=sharing)
